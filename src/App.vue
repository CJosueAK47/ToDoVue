...
<div class="container">
  <header class="p-5 mb-4 mt-4 bg-light rouded-3">
    ...
    <p>
      Você possui {{ getTarefasPendentes().length }} caralhada de tarefas
    </p>
  </header>
...
<ul class="list-group mt-4">
  <li class="list-group-item" v-for="tarefa in getTarefasFiltradas()">
    <input @change="evento => tarefa.finalizada = evento.target.checked" :checked="tarefa.finalizada" :id="tarefa.tituto" type="checkbox">
